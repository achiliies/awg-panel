...
/*
 * Used for anything destructive (delete a client, reset keys, restart the
 * tunnel): unlike Dialog there is no dismiss affordance, so the operator has to
 * pick cancel or confirm.
 */
...
>(({ className, ...props }, ref) => {
  // Cancel and confirm are the only buttons on screen while this is up, so the
  // toast stack has to be somewhere other than on top of them.
